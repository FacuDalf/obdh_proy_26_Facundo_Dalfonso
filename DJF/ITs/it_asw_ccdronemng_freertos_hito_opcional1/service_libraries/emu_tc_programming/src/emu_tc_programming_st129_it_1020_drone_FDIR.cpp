...
//DONE Complete steps 2, 3, 4, 5 & 6 to implement the Drone FDIR test

EmuGSS_TCProgram19_4 prog_FT_1030_step_2(FT_1030_TIME_step2,
		"IT_UAH_DRONE_FDIR_1030 step 2, 0x4004 Action enabled",
		0x4004);

EmuGSS_TCProgram12_1 prog_FT_1030_step_3(FT_1030_TIME_step3,
		"IT_UAH_DRONE_FDIR_1030 step 3, Enable Monitoring PMODID 0",
		0);

EmuGSS_TCProgram129_2 prog_FT_1030_step_4(FT_1030_TIME_step4,
		"IT_UAH_DRONE_1030 step 4, Set PID Params to 0.2, 0.15, 0.05",
		0.2, 0.15, 0.05);

EmuGSS_TCProgram129_1 prog_FT_1030_step_5(FT_1030_TIME_step5,
		"IT_UAH_DRONE_1030 step 5, Set Flight Plan X=150.5, Y= 90.5, Z= 30.2",
		150.5, 90.5, 30.2);

EmuGSS_TCProgram129_3 prog_FT_1030_step_6(FT_1030_TIME_step6,
		"IT_UAH_DRONE_1030 step 6, Exec Flight Plan");
